...
from src.utils.experiments_exploration_utils import process_experiment_2_results
...
def main():
    ...
    logging.info("▶️ STARTING MASTER TABLE GENERATION (EXPERIMENT 2)")
    ...
    for mode in MODES:
        ...
        for data_id in DATA_IDS:
            ...
            try:
                ...
                _, df_avg = process_experiment_2_results(
    ...
    logging.info("\n✅ MASTER TABLES FOR EXPERIMENT 2 PIPELINE FINISHED SUCCESSFULLY")
