...
# NOTA: Asegúrate de importar NOT_FEASIBLE_METHODS_TO_ADD si lo estás usando más abajo, 
# ya que en tu script original no aparecía en los imports.
from config.config_experiment_5 import CONFIG_EXPERIMENT, PROP_ERRORS_THRESHOLD, NOT_FEASIBLE_METHODS
    ...
    for data_id in DATA_IDS:
        ...
        try:
            _, df_avg, _, _ = process_experiment_5_results(
                ...
                not_feasible_methods_to_add=NOT_FEASIBLE_METHODS.get(data_id, []),
